		...
		<?php while ( have_posts() ) : the_post(); ?>
			<article id="post_<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<nav id="image-nav" class="image-navigation" role="navigation">
					<div class="image-nav-prev alignleft"><?php previous_image_link( false, '&laquo;&nbsp;' . __( 'Previous', 'green-garden' ) ); ?></div>
					<div class="image-nav-next alignright"><?php next_image_link( false, __( 'Next', 'green-garden' ) . '&nbsp;&raquo;' ); ?></div>
					<div class="clear"></div>
